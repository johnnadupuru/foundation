...
const Shiva = () => {
  ...
  return (
    <section className="px-3 lg:px-[50px] mt-3">
      <div>
        <div className=" lg:h-[650px] bg-cover bg-center rounded-xl" style={{backgroundImage:"url(shiva/shivabg.jpg)"}}>
          <div className="bg-black/80 h-full left-0 right-0 top-0 bottom-0 rounded-xl p-5">
            <div className=" ">
              <h1 className="text-white  md:text-5xl text-3xl font-lobster">Renovation of Lord Shiva Temple</h1>
            </div>
